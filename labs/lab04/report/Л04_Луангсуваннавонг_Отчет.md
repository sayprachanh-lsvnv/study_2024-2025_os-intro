...
![Установка Git-flow](image/pic/1.png){#fig:001 width=70%}
...
Я начинаю использовать pnpm, используя команду `source ~/.bashrc`, поскольку путь к файлу execute задан для этого файла (рис. [-@fig:006])
